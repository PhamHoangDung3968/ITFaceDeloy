...
//     if (this.state.showScanner && !prevState.showScanner) {
//       this.startScanner();
//     }
//   }
//   startScanner = () => {
...
class TKBStudent extends Component {
  ...
  startScanner = () => {
    ...
    const constraints = {
      video: {
        width: { ideal: 1920 }, // Đặt độ phân giải chiều rộng lý tưởng
        height: { ideal: 1080 }  // Đặt độ phân giải chiều cao lý tưởng
      }
    };
    ...
    html5QrCode.start(
      ...
      (decodedText, decodedResult) => {
        this.setState({ scanResult: decodedText });
      ...
      if (videoElement) {
        videoElement.onloadedmetadata = () => {
          ...
          // Hiển thị độ phân giải bằng alert
          alert(`Độ phân giải video: ${actualWidth}x${actualHeight}`);
        };
      }
    }).catch(err => {
