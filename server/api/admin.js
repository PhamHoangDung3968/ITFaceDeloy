...
router.post('/register_user', async (req, res) => {
  try {
    ...
    const response = await axios.post('https://875b-2001-ee0-4f80-9720-8de1-6e50-ea2f-9a23.ngrok-free.app/api/register', { name, image });
...
router.post('/re_register_user', async (req, res) => {
  try {
    ...
    const response = await axios.post('https://875b-2001-ee0-4f80-9720-8de1-6e50-ea2f-9a23.ngrok-free.app/api/re_register', { name, image });
...
router.post('/login_user', async (req, res) => {
  try {
    ...
    const response = await axios.post('https://875b-2001-ee0-4f80-9720-8de1-6e50-ea2f-9a23.ngrok-free.app/api/login', { name, image });
...
router.post('/check_user', async (req, res) => {
  try {
    ...
    const response = await axios.post('https://875b-2001-ee0-4f80-9720-8de1-6e50-ea2f-9a23.ngrok-free.app/api/check_user', { name });
...
router.get('/count_users_regist', async (req, res) => {
  try {
    ...
    const response = await axios.get('https://875b-2001-ee0-4f80-9720-8de1-6e50-ea2f-9a23.ngrok-free.app/api/count-pickle-files');
