...
router.post('/register_user', async (req, res) => {
  try {
    ...
    const response = await axios.post('https://26f0-2402-800-631d-2497-c2a-ac84-4837-b640.ngrok-free.app/api/register', { name, image });
...
router.post('/re_register_user', async (req, res) => {
  try {
    ...
    const response = await axios.post('https://26f0-2402-800-631d-2497-c2a-ac84-4837-b640.ngrok-free.app/api/re_register', { name, image });
...
router.post('/login_user', async (req, res) => {
  try {
    ...
    const response = await axios.post('https://26f0-2402-800-631d-2497-c2a-ac84-4837-b640.ngrok-free.app/api/login', { name, image });
...
router.post('/check_user', async (req, res) => {
  try {
    ...
    const response = await axios.post('https://26f0-2402-800-631d-2497-c2a-ac84-4837-b640.ngrok-free.app/api/check_user', { name });
...
router.get('/count_users_regist', async (req, res) => {
  try {
    ...
    const response = await axios.get('https://26f0-2402-800-631d-2497-c2a-ac84-4837-b640.ngrok-free.app/api/count-pickle-files');
